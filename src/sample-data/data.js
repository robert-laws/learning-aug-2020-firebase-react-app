...
const reservations = [
  {
    id: '12345',
    restaurantId: '123',
    userId: 'QqoRllQggOcN36sFzdChucRZy6D3', // replace these userIds with your own
  ...
  },
  {
    id: '12346',
    restaurantId: '345',
    userId: 'QqoRllQggOcN36sFzdChucRZy6D3',
...
const reviews = [
  {
    ...
    photoUrls: [
      'https://storage.googleapis.com/learning-aug-2020-firebase.appspot.com/reviewPhotos/hemingways-review-1.jpeg',
    ],
    text: `
...
const restaurants = [
  {
    ...
    name: "Hemingway's",
    imageUrl:
      'https://storage.googleapis.com/learning-aug-2020-firebase.appspot.com/restaurants/hemingways.jpeg',
    rating: 4.0,
    address: {
  ...
  },
  {
    ...
    name: "Ben's Burgers",
    imageUrl:
      'https://storage.googleapis.com/learning-aug-2020-firebase.appspot.com/restaurants/bens-burgers.jpeg',
    rating: 3.5,
    address: {
  ...
  },
  {
    ...
    name: 'Le Mollusc',
    imageUrl:
      'https://storage.googleapis.com/learning-aug-2020-firebase.appspot.com/restaurants/le-mollusc.jpeg',
    rating: 4.5,
    address: {
